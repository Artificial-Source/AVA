...
int main()
{
  ...
  terminal::Rendition const border_rendition(terminal_context.create_color_pair({0x56b6c2}, {0x0a0a0a}));
  ...
  terminal::Window input_area(size, top_left,
                              {terminal::Margin{.top = 1, .bottom = 2, .left = 3, .right = 2}, border_rendition, left_border});
