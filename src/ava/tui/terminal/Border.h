...
class Border
{
 private:
  ...
  Box box_;                             // The eight characters used for the border.
 ...
 public:
  ...
  Border() : margin_{}, box_{}, colors_{} { }

  // Construct a Border using `margin`, `border_color` and `box`.
  Border(Margin margin, ColorPair border_color, Box const& box = {Box::default_box})
    : margin_(margin), box_(box),
      colors_{border_color, border_color, border_color, border_color, border_color, border_color, border_color, border_color} { }

  // Construct a Border using `margin`, `border_color`, `left_hand_color` and `box`.
  Border(Margin margin, ColorPair border_color, ColorPair left_hand_color, Box const& box = {Box::default_box})
    : margin_(margin), box_(box),
  ...
  Box const& box() const { return box_; }
