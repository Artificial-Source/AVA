...
// does not create or update the underlying ncurses pad; call build() to (re)create
...
class Pad
{
 ...
 public:
  ...
  // Calls pad_.prefresh.
  void prefresh(Position pad_pos, Position viewport_pos, Dimension viewport_size);
